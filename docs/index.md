# Documentation KeepStreak

Bienvenue dans la documentation officielle de **KeepStreak**, la plateforme d'orchestration distribuée pour automatisations GitHub sécurisées.

## 🎯 Vision du Projet
KeepStreak permet de maintenir une activité réelle sur GitHub via des **Shadow Workers** (GitHub Actions) pilotés par un cerveau central (NestJS/Redis), garantissant un stockage **Zero-Token**.
